...
export function AnnouncementComposer({
  ...
  async function submit(event: FormEvent) {
    ...
    setSaving(true);
    try {
      await api.createAnnouncement({ ...values, title: values.title.trim(), body: values.body.trim(), expiresAt: values.expiresAt || undefined });
