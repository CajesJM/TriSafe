...
export function FranchiseEditor({
  ...
  return (
    <section className="card franchise-editor">
      <div className="form-heading">
        <div>
          <span className="eyebrow">FRANCHISE &amp; DRIVER STATUS</span>
          <h3>Update {driver.fullName}</h3>
          <p>
            The selected status applies to both the driver and franchise. A past
            expiration date always results in Expired.
          </p>
        </div>
      ...
      <form onSubmit={submit}>
        <div className="form-grid">
          <label className="field">
            ...
            >
              ...
              <option value="SUSPENDED">Suspended — manually blocked</option>
              <option value="EXPIRED">Expired — franchise ended</option>
            </select>
          </label>
          <label className="field">
            <span>Franchise expiry date</span>
            <input
              type="date"
              value={expiresAt}
        ...
        <div className="form-actions">
          ...
          <button
            ...
            type="submit"
          >
            {saving ? "Saving…" : "Save status and franchise"}
          </button>
        </div>
      </form>
    </section>
