...
export class CreateUserDto {
  ...
  @ValidateIf(
    (object: CreateUserDto, value) =>
      object.role === UserRole.PASSENGER ||
      object.role === UserRole.LGU_ADMIN ||
      value !== undefined,
  )
  @IsString()
  @Length(3, 15)
  @Matches(usernamePattern, {
    message:
      "username must begin with a letter and may use lowercase letters, numbers, dots, underscores, or hyphens without repeated separators",
  })
  username?: string;
...
export class UpdateDriverRecordDto {
  ...
  @ValidateIf(
    (value: UpdateDriverRecordDto) => value.vehicleType === "TRICYCLE",
  )
  @IsString()
  @Length(2, 30)
  @Matches(recordNumber)
  bodyNumber?: string;
  @ValidateIf(
    (value: UpdateDriverRecordDto) => value.vehicleType === "HABAL_HABAL",
  )
  @IsString()
  @Length(2, 30)
  @Matches(recordNumber)
