...
async function main() {
  ...
  await prisma.user.upsert({ where: { id: 'lgu-admin-demo' }, update: { username: 'lguadmin', email: 'admin@gmail.com', passwordHash: hashPassword('admin12345') }, create: { id: 'lgu-admin-demo', role: 'LGU_ADMIN', fullName: 'Trinidad LGU Administrator', username: 'lguadmin', email: 'admin@gmail.com', passwordHash: hashPassword('admin12345') } });
